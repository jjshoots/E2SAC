...
class Q_Ensemble(nn.Module):
    ...
    def __init__(
        ...
        networks = [
            AWACNet.Critic(act_size, obs_atti_size, obs_targ_size, context_length)
...
class GaussianActor(nn.Module):
    ...
    def __init__(self, act_size, obs_atti_size, obs_targ_size, context_length):
        super().__init__()
        self.net = AWACNet.Actor(act_size, obs_atti_size, obs_targ_size, context_length)
...
class AWAC(nn.Module):
    ...
    Largely inspired from: https://github.com/Junyoungpark/Pytorch-AWAC/blob/main/src/Learner/AWAC.py
    """
    ...
    def calc_actor_loss(self, obs_atti, obs_targ, terms):
        ...
        # advantage weighting
        weighting = torch.exp(1.0 / self.lambda_parameter * q)
