...
if [ "$hostname" = "arctic-linx" ]
  ...
  xvfb-run -s '-screen 1 1400x900x24' python3 src/main.py --train --wandb --wandb_name='e2SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/main.py --train --wandb --wandb_name='e2SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/main.py --train --wandb --wandb_name='e2SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/main.py --train --wandb --wandb_name='e2SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/main.py --train --wandb --wandb_name='e2SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/mainSAC.py --train --wandb --wandb_name='SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/mainSAC.py --train --wandb --wandb_name='SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/mainSAC.py --train --wandb --wandb_name='SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/mainSAC.py --train --wandb --wandb_name='SAC'
  xvfb-run -s '-screen 1 1400x900x24' python3 src/mainSAC.py --train --wandb --wandb_name='SAC'
