...
def process_sweeps(title, sweep_uri_dict, baselines_dict):
    ...
    plt.savefig(f"plots/{filename}-guide-sup.pdf", dpi=100)
    # plt.show()
...
if __name__ == "__main__":
    ...
    sweep_uri_dict = {}
    sweep_uri_dict["Supervision + Guidance"] = "jjshoots/CCGE2/4ouyzaqo"
    sweep_uri_dict["Guidance Only"] = "jjshoots/CCGE2/0093ne7x"
    sweep_uri_dict["Supervision Only"] = "jjshoots/CCGE2/aksuk8jv"
