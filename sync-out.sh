...
# rsync -avr --progress --stats --exclude-from='rsync_ignore_out.txt' ./ dream:~/e2SAC/ --delete
# rsync -avr --progress --stats --exclude-from='rsync_ignore_out.txt' ./ prophet:~/e2SAC/ --delete
