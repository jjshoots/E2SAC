...
# rsync -avr --exclude-from='rsync_ignore_out.txt' ./ availab-dl3:~/Sandboxes/e2SAC/ --delete
# rsync -avr --exclude-from='rsync_ignore_out.txt' ./ availab-dl4:~/Sandboxes/e2SAC/ --delete
